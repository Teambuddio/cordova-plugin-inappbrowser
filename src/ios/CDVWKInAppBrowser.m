...
- (void)createViews
{
    ...
    if (
        [self settingForKey:@"OverrideInAppUserAgent"] == nil &&
    ...
    if ([self settingForKey:@"OverrideInAppUserAgent"] != nil) {
        self.webView.customUserAgent = [self settingForKey:@"OverrideInAppUserAgent"];
    }
